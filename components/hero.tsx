  ...
  return (
    <div className='relative h-[85vh] lg:h-screen flex items-center justify-center overflow-hidden  px-4 sm:px-6'>
      ...
      <div className='relative w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-5xl z-10'>
        <motion.h1
          className='text-4xl sm:text-4xl space-y-2.5  md:text-5xl lg:text-9xl  font-extrabold mb-4 sm:mb-6 text-[#9a3412]'
        ...
        >
          <Link
            ...
            className={cn(
              ...
              'h-11 rounded-full justify-between shadow-none   text-muted-foreground outline-none hover:bg-white  bg-gray-50 border-[0.1px]'
            )}
          >
